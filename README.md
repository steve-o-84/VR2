...
## Fehlerkorrekturen in 0.5.1

- Das Ergebnisfenster bleibt beim Start zuverlässig ausgeblendet.
- `[hidden]` kann nicht mehr durch die Modal-CSS-Regel überschrieben werden.
- „Nächster Gast“ erhält sofort einen funktionierenden Notfall-Handler.
- Die Desktop-Version wartet nicht mehr auf die WebXR-Erkennung.
- Babylon.js besitzt eine zweite CDN-Fallback-Adresse.
- Ladefehler werden auf dem Startbildschirm verständlich angezeigt.
